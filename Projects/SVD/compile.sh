...
# icpc -DMKL_ILP64 -DMKL_INT=size_t -L${MKLROOT}/lib/intel64 -lmkl_intel_ilp64 -lmkl_intel_thread -lmkl_core -liomp5 -lpthread -lm -ldl -std=c++11 -I${MKLROOT}/include  ./src/utils/util.cpp ./src/utils/matrix.cpp ./src/utils/block.cpp ./src/svd/one-sided/svd.cpp ./src/svd/two-sided/nsvd.cpp main.cpp ./src/svd/two-sided/svd_subprocedure.cpp ./src/svd/two-sided/svd_blocked.cpp -o main
