#!/bin/bash
DEFINED_FUNCTIONS="-DPRRBJRS -DCOLBNSVD -DPRRBNSVD -DCOLBNSVD_AVX -DPRRBNSVD_AVX -DCOLWISE -DCACHE"
...
#-DMKL_INT=size_t -DMKL_ILP64 -DPRRBJRS -DCOLBNSVD -DPRRBNSVD -DCOLBNSVD_AVX -DPRRBNSVD_AVX -DCOLWISE -DCACHE \
