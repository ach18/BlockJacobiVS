#!/bin/bash
DEFINED_FUNCTIONS="-DPRRBJRS -DRRBNSVD -DPRRBNSVD -DRRBNSVD_AVX -DPRRBNSVD_AVX"
...
#-DMKL_INT=size_t -DMKL_ILP64 -DPRRBJRS -DRRBNSVD -DPRRBNSVD -DRRBNSVD_AVX -DPRRBNSVD_AVX \
